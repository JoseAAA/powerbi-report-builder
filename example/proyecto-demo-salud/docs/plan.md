...
**De que trata:** Salud / operaciones clinicas (Sede / Servicio / Indicadores).

## 1. Que vamos a medir

| Indicador | Tipo |
|---|---|
| % Ocupacion  ← **el principal** | Porcentaje |
| % Entregas a tiempo | Porcentaje |
| Tiempo de Estancia | Absoluto |
| % Cumplimiento Citas | Porcentaje |
| Reingresos 30 dias | Absoluto |
...
- **Sede** — Cortar por sede
- **Servicio** — Cortar por servicio (agrupado en Servicio Agrupado)
...
| ¿Como vamos en % Ocupacion? | cardVisual |
...
- [ ] ¿'% Ocupacion' es de verdad el indicador que abre el reporte, o hay otro mas importante?
- [ ] ¿Los cortes por Sede y Servicio son los que usa tu negocio, o falta alguno?
